...
public class deo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //String s = ManagerZPLComand.getComandosZPL("CODE_128", "1.18x1.18", 3, lista, "RED SOLUCIONES SAC");
            //String s = ManagerZPLComand.getComandosZPL("EAN_8", "1.18x1.18", 3, lista, "RED SOLUCIONES SAC");
            //String s = ManagerZPLComand.getComandosZPL("EAN_13", "1.18x1.18", 3, lista, "RED SOLUCIONES SAC");
